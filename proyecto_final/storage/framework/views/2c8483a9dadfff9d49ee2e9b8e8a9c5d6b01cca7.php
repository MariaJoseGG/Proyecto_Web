...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('codigos/estilos.css')); ?>">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img class="img-fluid" src="<?php echo e(asset('img/logoSES.png')); ?>" alt="SES" width="250">
                </a>
            </div>
        </nav>
        <nav class="navbar navbar-expand-lg">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo e(route('api')); ?>">Api</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('fluids.index')); ?>">Ingreso liquidos</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
...
</html><?php /**PATH C:\Users\tatis\Desktop\Proyecto_Web\proyecto_final\resources\views/layouts/app.blade.php ENDPATH**/ ?>